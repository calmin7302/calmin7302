...
------------------------------------------------------------------------------
--ABS(숫자): 절대값
SELECT ABS(-30.35), ABS(30.35) FROM DUAL;
------------------------------------------------------------------------------
--FLOOR(숫자): 내림(작은 숫자를 선택)
...
SELECT TRUNC(1234.13, 1), TRUNC(1234.123, 2) FROM DUAL; -- 1234.1,1234.12
------------------------------------------------------------------------------
-- MOD(숫자, 나누는수): 나머지
SELECT MOD(1000, 3), MOD(999, 5) FROM DUAL;
------------------------------------------------------------------------------
-- SIGN(숫자): 부호값 반환(양수: 1, 제로: 0, 음수: -1)
SELECT SIGN(0), SIGN(55), SIGN(-55) FROM DUAL; -- 0, 1, -1
------------------------------------------------------------------------------
-- POWER(숫자, n): 숫자의 n제곱 값 계산(POWER(2, 3) -> 8) 
SELECT POWER(2,3), POWER(2,8), POWER(2,16), POWER(2,32) FROM DUAL;
